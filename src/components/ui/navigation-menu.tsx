...
>(({ className, children, ...props }, ref) => (
  <NavigationMenuPrimitive.Root
    ref={ref}
    className={cn("flex flex-1 items-center justify-center max-w-max relative z-10", className)}
    {...props}
  >
    {children}
...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.List
    ref={ref}
    className={cn("flex flex-1 group items-center justify-center list-none space-x-1", className)}
    {...props}
  />
));
...
>(({ className, children, ...props }, ref) => (
  ...
  >
    {children}{" "}
    <ChevronDown
      className="duration-300 group-data-[state=open]:rotate-180 h-3 ml-1 relative top-[1px] transition w-3"
      aria-hidden="true"
    />
  </NavigationMenuPrimitive.Trigger>
));
...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Content
    ref={ref}
    className={cn(
      "data-[motion=from-end]:slide-in-from-right-52 data-[motion=from-start]:slide-in-from-left-52 data-[motion=to-end]:slide-out-to-right-52 data-[motion=to-start]:slide-out-to-left-52 data-[motion^=from-]:animate-in data-[motion^=from-]:fade-in data-[motion^=to-]:animate-out data-[motion^=to-]:fade-out left-0 md:absolute md:w-auto top-0 w-full",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div className={cn("absolute flex justify-center left-0 top-full")}>
