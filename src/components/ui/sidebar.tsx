    ...
    return (
      ...
      >
        ...
        >
          <div
            data-sidebar="sidebar"
            className="bg-sidebar flex flex-col group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:shadow h-full w-full"
          >
            {children}
          </div>
        </div>
    ...
    return (
      <button
        ...
        className={cn(
          ...
          "group-data-[collapsible=offcanvas]:after:left-full group-data-[collapsible=offcanvas]:hover:bg-sidebar group-data-[collapsible=offcanvas]:translate-x-0",
...
>(({ className, ...props }, ref) => {
  return (
    <Input
      ...
      data-sidebar="input"
      className={cn(
        "bg-background focus-visible:ring-2 focus-visible:ring-sidebar-ring h-8 shadow-none w-full",
        className,
      )}
      {...props}
    />
...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "[&>svg]:shrink-0 [&>svg]:size-4 duration-200 ease-linear flex focus-visible:ring-2 font-medium h-8 items-center outline-none px-2 ring-sidebar-ring rounded-md shrink-0 text-sidebar-foreground/70 text-xs transition-[margin,opacity]",
...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "[&>svg]:shrink-0 [&>svg]:size-4 absolute aspect-square cursor-pointer flex focus-visible:ring-2 hover:bg-sidebar-accent hover:text-sidebar-accent-foreground items-center justify-center outline-none p-0 right-3 ring-sidebar-ring rounded-md text-sidebar-foreground top-3.5 transition-transform w-5",
...
>(({ className, asChild = false, showOnHover = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "[&>svg]:shrink-0 [&>svg]:size-4 absolute aspect-square cursor-pointer flex focus-visible:ring-2 hover:bg-sidebar-accent hover:text-sidebar-accent-foreground items-center justify-center outline-none p-0 peer-hover/menu-button:text-sidebar-accent-foreground right-1 ring-sidebar-ring rounded-md text-sidebar-foreground top-1.5 transition-transform w-5",
        // Increases the hit area of the button on mobile.
        "after:-inset-2 after:absolute after:md:hidden",
...
>(({ asChild = false, size = "md", isActive, className, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      data-active={isActive}
      className={cn(
        "-translate-x-px [&>span:last-child]:truncate [&>svg]:shrink-0 [&>svg]:size-4 [&>svg]:text-sidebar-accent-foreground active:bg-sidebar-accent active:text-sidebar-accent-foreground aria-disabled:opacity-50 aria-disabled:pointer-events-none cursor-pointer disabled:cursor-not-allowed disabled:opacity-50 disabled:pointer-events-none flex focus-visible:ring-2 gap-2 h-7 hover:bg-sidebar-accent hover:text-sidebar-accent-foreground items-center min-w-0 outline-none overflow-hidden px-2 ring-sidebar-ring rounded-md text-sidebar-foreground",
